...
There's an error here, concerning the exponential map and the generators. What it's written refers to the exponential map with no $i$ factor. Taking into consideration, we should have $i$ factors on infinitesimal rotation and the algebra should be made of hermitian matrices.
