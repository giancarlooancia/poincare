...
\begin{proof}
    ...
    \begin{align*}
        ...
        &+\frac{1}{8} \omega \omega' \omega M^3 + \frac{1}{4} \omega \omega' \epsilon M^2 P \\
        &+\frac{1}{4} \omega \epsilon' \omega M P M + \frac{1}{2} \omega \epsilon' \epsilon M P^2 \\
        &+\frac{1}{2} \epsilon \omega P M + \epsilon^2 P^2 \\
        &+\frac{1}{4} \epsilon \omega' \omega P M^2 + \frac{1}{2} \epsilon \omega' \epsilon P M P \\
        &+\frac{1}{8} \epsilon \epsilon' \omega P^2 M + \epsilon \epsilon' \epsilon P^3 \\
        &= \1 -\frac{i}{2} (\omega + \omega') M - i (\epsilon + \epsilon') P \\
        &+ \frac{1}{4} \omega_{\mu\nu} \omega'_{\rho\sigma} \comm{M^{\rho\sigma}}{M^{\mu\nu}} \\
        &+ \epsilon_\alpha \epsilon'_\beta \comm{P^\beta}{P^\alpha} \\
        &+\frac{1}{2} \omega_{\mu\nu} \epsilon_\alpha \{ M^{\mu\nu}, P^\alpha \} + \frac{1}{2} \omega'_{\rho\sigma} \epsilon_\alpha \comm{M^{\rho\sigma}}{P^\alpha} + \frac{1}{2} \omega_{\mu\nu} \epsilon'_\beta \comm{P^\beta}{M^{\mu\nu}}.
    \end{align*}
